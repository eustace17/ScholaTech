...
public final class ActivityStudentBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView mListStudents;

  private ActivityStudentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ListView mListStudents) {
  ...
  public static ActivityStudentBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.mListStudents;
      ListView mListStudents = ViewBindings.findChildViewById(rootView, id);
      if (mListStudents == null) {
        break missingId;
      }

      return new ActivityStudentBinding((ConstraintLayout) rootView, mListStudents);
    }
