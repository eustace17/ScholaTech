...
public final class ActivityStudentUpdateBinding implements ViewBinding {
  ...
  private ActivityStudentUpdateBinding(@NonNull ConstraintLayout rootView, @NonNull EditText UPI,
      @NonNull ConstraintLayout linearLayout, @NonNull Button mBtnUpdate,
      ...
      @NonNull EditText mEdtStdName, @NonNull TextView mTxtParents, @NonNull TextView mTxtStudent) {
  ...
  public static ActivityStudentUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.UPI;
      EditText UPI = ViewBindings.findChildViewById(rootView, id);
      if (UPI == null) {
        break missingId;
      }
      ...
      return new ActivityStudentUpdateBinding((ConstraintLayout) rootView, UPI, linearLayout,
          mBtnUpdate, mEdFrName, mEdtAdmNo, mEdtDOA, mEdtDOB, mEdtFrCell, mEdtFrId,
          mEdtFrOccupation, mEdtGrade, mEdtMrCell, mEdtMrId, mEdtMrJob, mEdtMrName, mEdtStdName,
          mTxtParents, mTxtStudent);
    }
